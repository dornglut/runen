...
Public validated constructors reject values whose recursive logical shape does not match the declared Model type. The fixture error type, including zero explicit fixture multiplicity, finite-carrier multiplicity overflow, and rejection of invalid bounded-query fixtures, is verification machinery rather than a compiler diagnostic or normative runtime query-fault contract.
