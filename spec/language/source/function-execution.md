...
A result-bearing call, nested construction, represented Boolean operator, or producer-backed field-value use used as an initializer must complete before that field transient exists and before a later initializer begins.
