...
3. commit the resulting speculative state to the containing source producer-validation state only when the complete operand producer is source-valid; and
