...
fn add_sub_mul_preserve_zero_and_wrap_boundaries_for_every_integer_kind() {
    let cases = vec![
        ...
        Case {
            ...
            left: Value::I16(i16::MAX),
            right: Value::I16(2),
            expected: Value::I16(-2),
        },
        Case {
            ty: ScalarType::I32,
            op: ArithmeticOp::Add,
            left: Value::I32(i32::MIN),
            right: Value::I32(0),
        ...
        Case {
            ...
            left: Value::I32(i32::MAX),
            right: Value::I32(2),
            expected: Value::I32(-2),
        },
        Case {
            ty: ScalarType::I64,
            op: ArithmeticOp::Add,
            left: Value::I64(i64::MIN),
            right: Value::I64(0),
        ...
        Case {
            ...
            left: Value::U16(0),
            right: Value::U16(0),
            expected: Value::U16(0),
        },
        Case {
            ty: ScalarType::U16,
            op: ArithmeticOp::Add,
            left: Value::U16(u16::MAX),
            right: Value::U16(1),
            expected: Value::U16(0),
        },
        Case {
        ...
        Case {
            ...
            left: Value::U64(0),
            right: Value::U64(0),
            expected: Value::U64(0),
        },
        Case {
            ty: ScalarType::U64,
            op: ArithmeticOp::Add,
            left: Value::U64(u64::MAX),
            right: Value::U64(1),
            expected: Value::U64(0),
        },
        Case {
